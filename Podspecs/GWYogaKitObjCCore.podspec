Pod::Spec.new do |s|
  ...
  s.version          = '1.0.3'
  s.summary          = 'Objective-C bridge for all GWYogaKit modules'
  s.description      = <<-DESC
    Objective-C compatible wrappers for GWYogaKit, exposing
    yoga layout properties to Objective-C code across all submodules:
    Core, Animation, DSL, Stylesheet, LayoutCache, and HTML.
  DESC
  ...
  s.source_files = 'Sources/GWYogaKit/**/ObjC/**/*.swift'
